        ...
        <div class="p-md-4 p-3">
            ...
            <div class="row bowtie-main-content d-none">
                ...
                <div class="col-md-6">
                    ...
                    <div class="row d-xl-flex d-none justify-content-center align-items-center diagram">
                        <div class="col-xl-3 col-4 d-flex flex-column align-items-end">
                            <div class="node my-5">Choose Correct Action</div>
                            <div class="node my-5">Choose Correct Action</div>
                            <!-- <div class="node my-5">Choose Correct Action</div>F -->
                        </div>
                        <div class="col-xl-3 col-4 d-flex flex-column align-items-center">
                            <div class="node-main my-5">Choose Correct Condition</div>
                        </div>
                        <div class="col-xl-3 col-4 d-flex flex-column align-items-start">
                ...
                <div class="row d-xl-none justify-content-center align-items-center diagram">
