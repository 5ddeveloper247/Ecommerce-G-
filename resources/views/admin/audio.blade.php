...
<div class="content">
    <div id="audio">
        <div class="p-md-4 p-3">
            <div id="products">
                <form>
                    ...
                    <div class="row justify-content-center gx-0 gy-2 gap-4 mb-4">
                        ...
                        <div class="col d-flex justify-content-center align-items-center d-card py-md-4 py-3 px-3 audi-bank-form">
                                        ...
                                        <td class="text-end">
                                            <div class="btn-reveal-trigger position-static">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <a class="dropdown-item audi-bank-form" type="button">View</a>
            ...
            <div class="audi-bank-form-detail d-none">
                <div class="d-flex align-items-center mb-4">
                    <div class="back-to-audi-add-form mb-2" style="cursor:pointer">
                ...
                <form>
                    <div class="row mb-3">
                        <div class="col-md-6 form-floating mb-3">
                            <input type="audiobankcode" class="form-control" id="floatingInput" placeholder="Bank Code" disabled>
                            <label class="ms-2" for="floatingInput">Audio Bank Code</label>
                        </div>
                        <div class="col-md-6 form-floating mb-3">
                            <input type="audiobanktype" class="form-control" id="floatingInput" placeholder="Bank Type">
                            <label class="ms-2" for="floatingInput">Audio Bank Type</label>
                        </div>
                        <div class="col-md-6 form-floating mb-3">
