            ...
            <form id="products">
                <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Enrolled Student With Exams</li>
                    </ol>
                </nav>
                        ...
                        <table id="enrolled-students" class="table table-responsive">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-nowrap" scope="col">EXAM NAME</th>
                                    <th class="text-nowrap" scope="col">EXAM DATE</th>
                                    <th class="text-nowrap" scope="col">EXAM SCORE</th>
            ...
            <div class="enroll-students-detail d-none">
                <div class="row g-3 h-100">
                    <div class="d-flex align-items-center mb-4">
                        <div class="back-to-enroll-students-list mb-2" style="cursor:pointer">
                        ...
                        <nav class="ms-3 mt-2" style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="#">Enrolled Student</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Enrolled Student Detail</li>
                            </ol>
                        </nav>
                    </div>
                                    ...
                                    <div>
                                        <div class="d-flex align-items-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" viewBox="0 0 48 48">
                                                <path fill="none" stroke="red" stroke-linecap="round" stroke-linejoin="round" stroke-width="4" d="M38 4H10a2 2 0 0 0-2 2v36a2 2 0 0 0 2 2h28a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2M17 30h14m-14 6h7m-4-15l8-8m0 8l-8-8" />
                                            </svg>
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <div class="table-responsive scrollbar px-1">
                            <table class="table fs-9 mb-0 table-hover">
                                <thead>
                                    <tr>
                                        <th class="sort white-space-nowrap align-middle ps-4 text-nowrap" scope="col">SUBJECT ID</th>
                                        <th class="sort align-middle ps-4 text-nowrap" scope="col">COURSE NAME</th>
                                        <th class="sort align-middle ps-4 text-nowrap" scope="col">TEACHER</th>
                                        <th class="sort align-middle ps-4 text-nowrap" scope="col">CREDITS</th>
                                    </tr>
                                </thead>
