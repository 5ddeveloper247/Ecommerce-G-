                ...
                <form>
                    ...
                    <div id="products">
                        <div class="px-4 py-4 bg-white shadow table-container">
                            <table id="sub-adminn" class="table table-responsive">
                                <thead>
                                    <tr>
            ...
            <div class="ppt-bank-form-detail d-none">
                ...
                <form>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <div class="form-floating">
                                <input type="text" class="form-control" id="userCode" placeholder="Auto Number" disabled>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <div class="form-floating">
                                <select class="form-select" id="roleType" aria-label="Role Type" required>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-floating">
                                <select class="form-select" id="status" aria-label="Status" required>
                    ...
                    <h4 class="text-center my-3">Menu Control</h4>
                    <div class="mb-3 d-flex flex-wrap justify-content-between align-items-center">
                        ...
                        <div class="form-check col-4 my-2">
                            <input class="form-check-input" type="checkbox" id="role2" checked>
