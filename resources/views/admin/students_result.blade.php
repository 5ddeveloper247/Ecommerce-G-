...
<div class="content">
                        ...
                        <table id="enrolled-subscription" class="table table-responsive">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-nowrap" scope="col" class="text-start">ROLL NUMBER</th>
                                    <th scope="col" data-sort="category">CLASS</th>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-reveal-trigger position-static">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                <a class="dropdown-item view-student-result" type="button">View</a>
            ...
            <div class="student-result-detail d-none">
                <div class="row g-3 h-100">
                    <div class="d-flex align-items-center mb-4">
                        <div class="back-to-student-result-list mb-2" style="cursor:pointer">
                        ...
                        <nav class="ms-3 mt-2" style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Student Result Detail</li>
                            </ol>
                        </nav>
                    </div>
                ...
                <div class="table-responsive scrollbar px-1">
                    <table class="table fs-9 mb-0 table-hover">
                        <thead>
                            <tr>
                                <th class="sort align-middle ps-4 text-nowrap" scope="col" data-sort="email">SUBJECT</th>
                                <th class="sort white-space-nowrap align-middle ps-4 text-nowrap" scope="col">DATE</th>
                        ...
                        <tbody class="list" id="students-table-body">
                            <tr class="position-static">
                                <td class="email white-space-nowrap ps-4 text-primary">
                                    Science
                                </td>
    ...
    <script>
        ...
        $('#enrolled-subscription-inner').DataTable({
            dom: 'Bfrtip',
            pageLength: 10,
            buttons: [{
                extend: 'csv',
