...
<div class="d-none">
    <nav class="navbar navbar-expand-lg header-top pb-0">
        <div class="container">
            ...
            <div class="btn whatsapp-contact d-flex align-items-center" type="button">
                ...
                <a class="ms-2 text-start" href="">0098765432</a>
            </div>
        </div>
    </nav>
    <nav class="navbar navbar-expand-lg header-bottom pt-0">
        <div class="container">
            <div class="dropdown categories-dropdown">
                <div class="btn d-flex align-items-center shopbycategories rounded-pill dropdown-toggle py-1" type="button" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 bottom-header-ul d-flex align-items-center flex-wrap">
                <li class="nav-item px-lg-3 px-2">
                    <a class="nav-link px-3 py-2" aria-current="page" href="#">Specials</a>
                </li>
                <li class="nav-item px-lg-3 px-2">
                    <a class="nav-link px-3 py-2" aria-current="page" href="#">Contact Us</a>
                </li>
                <li class="nav-item px-lg-3 px-2">
                    <a class="nav-link px-3 py-2" href="#">About Us</a>
                </li>
                <li class="nav-item px-lg-3 px-2 position-relative more-dropdown">
...
<!-- ________________________________________________________New_________________________________________________ -->
        ...
        <div class="container">
            ...
            <ul class="mb-2 mb-lg-0 bottom-header-ul d-flex flex-wrap align-items-center">
                ...
                <li class="nav-item px-2">
                    <a class="nav-link px-3 py-2" aria-current="page" href="#">Best Seller</a>
                </li>
                <li class="nav-item px-2">
                ...
                <li class="nav-item px-2">
                    <a class="nav-link px-3 py-2" aria-current="page" href="{{'contact_us'}}">Contact Us</a>
                </li>
                <li class="nav-item px-2">
                    <a class="nav-link px-3 py-2" href="{{'about_us'}}">About Us</a>
                </li>
...
<div class="d-lg-none d-block">
    <nav class="navbar navbar-expand-lg small-nav">
        <div class="container">
            <!-- Offcanvas Toggle Button -->
            <button class="btn me-2" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasMenuu" aria-controls="offcanvasMenuu">
                <svg xmlns="http://www.w3.org/2000/svg" width="1.7em" height="1.7em" viewBox="0 0 24 24">
                    <path fill="currentColor" d="M3 18v-2h18v2zm0-5v-2h18v2zm0-5V6h18v2z"></path>
                </svg>
            </button>
