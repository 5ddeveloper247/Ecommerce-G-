                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="d-flex align-items-center col-md-3 col-12 mb-4 mb-md-0">
                                ...
                                <h6 class="mb-0 ms-2 text-sm-nowrap text-wrap">Daily Discount</h6>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="d-flex align-items-center col-md-3 col-12 mb-4 mb-md-0">
                                ...
                                <h6 class="mb-0 ms-2 text-sm-nowrap text-wrap">Send A Free Gift</h6>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="d-flex align-items-center col-md-3 col-12 mb-4 mb-md-0">
                                ...
                                <h6 class="mb-0 ms-2 text-sm-nowrap text-wrap">Free Shipping</h6>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="d-flex align-items-center col-md-3 col-12 mb-4 mb-md-0">
