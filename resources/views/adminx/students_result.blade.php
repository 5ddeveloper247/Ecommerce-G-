    ...
    <div id="students-result">
        <div class="p-md-4 p-3">
                            ...
                            <table class="table fs-9 mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="sort align-middle ps-4 text-nowrap" scope="col">ROLL NUMBER</th>
                                        <th class="sort align-middle ps-4 text-nowrap" scope="col">CLASS</th>
                                        <th class="sort align-middle ps-4 text-nowrap" scope="col">SUBJECT</th>
                                        <th class="sort align-middle ps-4 text-nowrap" scope="col">MARKS</th>
                                        <th class="sort align-middle ps-4 text-nowrap" scope="col">GRADE</th>
                                        <th class="sort text-end align-middle pe-0 ps-4 text-nowrap" scope="col"></th>
                                    </tr>
                                </thead>
                                <tbody class="list" id="students-results-table-body">
                                    <tr class="position-static">
                                        <td class="student-name align-middle ps-4">
                                            John Doe
                                        </td>
                                        <td class="roll-number white-space-nowrap ps-4">
                                            12345
                                        </td>
                                        <td class="class ps-4">
                                            10th Grade
                                        </td>
                                        <td class="subject white-space-nowrap ps-4">
                                            Mathematics
                                        </td>
                                        <td class="marks ps-4">
                                            95
                                        </td>
                                        <td class="grade white-space-nowrap ps-4">
                                            A+
                                        </td>
                                        <td class="align-middle white-space-nowrap text-end pe-0 ps-4 btn-reveal-trigger">
                                            <div>
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end py-2">
                                                    <a class="dropdown-item view-student-result">View</a>
            ...
            <div class="student-result-detail d-none">
                ...
                <div class="table-responsive mt-3 px-1">
                    <table class="table fs-9 mb-0">
                        <thead>
                            <tr>
                                <th class="sort white-space-nowrap align-middle ps-4 text-nowrap" scope="col">NAME</th>
                                <th class="sort align-middle ps-4 text-nowrap" scope="col">DATE</th>
                                <th class="sort align-middle ps-4 text-nowrap" scope="col">OBTAINED MARKS</th>
                                <th class="sort align-middle ps-4 text-nowrap" scope="col">TOTAL MARKS</th>
                                <th class="sort align-middle ps-4 text-nowrap" scope="col">STATUS</th>
                                <th class="sort text-end align-middle pe-0 ps-4 text-nowrap" scope="col"></th>
                            </tr>
                        </thead>
                        <tbody class="list" id="results-table-body">
                            <tr class="position-static">
                                <td class="name align-middle ps-4" rowspan="2">
                                    John Doe
                                </td>
                                <td class="date align-middle ps-4">
                                    2024-07-22
                                </td>
                                <td class="obtained-marks align-middle ps-4">
                                    85
                                </td>
                                <td class="total-marks align-middle ps-4">
                                    100
                                </td>
                                ...
                                <td class="align-middle white-space-nowrap text-end pe-0 ps-4 btn-reveal-trigger">
                                    <div>
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end py-2">
                                            <a class="dropdown-item view-result">View</a>
