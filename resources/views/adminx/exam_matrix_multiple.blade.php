            ...
            <form id="products">
                <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Exam Matrix Multiple</li>
                    </ol>
                </nav>
                ...
                <div>
                    <div class="px-4 pt-4 pb-5 bg-white shadow">
                        <table id="exam-matrix-multiple" class="table table-responsive">
                            <thead>
                                <tr>
                                    <th scope="col">ID</th>
            ...
            <div class="row exam-matrix-main-content d-none">
                <div class="d-flex align-items-center mb-4">
                    ...
                    <nav class="ms-3 mt-2" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">Matrix Multiple</a></li>
        ...
        <div class="modal-content border">
            <form id="addEventForm" autocomplete="off">
                <div class="modal-header justify-content-between border-0 px-4 py-3">
                    <h4 class="modal-title text-white">Exam Matrix Multiple</h4>
...
<script>
    $('#exam-matrix-multiple').DataTable({
        dom: 'Bfrtip',
        pageLength: 10,
        buttons: [{
            extend: 'csv',
