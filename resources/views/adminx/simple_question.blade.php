        ...
        <div class="p-md-4 p-3">
            <div id="products">
                <div class="px-4 px-lg-6 bg-white border-top border-bottom border-translucent position-relative top-1">
                    <div class="my-4">
                        <button class="btn btn-outline-primary bank-form px-md-5 px-3">Add Bank Form</button>
                    </div>
            ...
            <div class="bank-form-detail d-none">
                <div class="d-flex">
                    <div class="back-to-add-form" style="cursor:pointer">
                    ...
                    <h3 class="mx-auto mb-3">Bank Details</h3>
                </div>
                <form>
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <label for="bankCode" class="form-label">Bank Code</label>
                            <input type="text" class="form-control" id="bankCode" placeholder="Bank Code" disabled>
                        </div>
                        <div class="col-md-6">
                            <label for="bankType" class="form-label">Bank Type</label>
                            <input type="text" class="form-control" id="bankType" placeholder="Bank Type">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-6">
