...
<div class="content">
    <div id="multiple-response-grouping">
        <div class="p-md-4 p-3">
            <form id="products">
                <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#">Quiz</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Multiple Response Grouping</li>
                    </ol>
                </nav>
            ...
            <div class="row rational-main-content d-none">
                <div class="d-flex align-items-center mb-4">
                    ...
                    <nav class="ms-3 mt-2" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">Multi Response Grouping</a></li>
                ...
                <div class="col-md-6">
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        <div type="button" class=" my-4 d-flex align-items-center add-row">
                            <h6 class="me-4 text-nowrap">Total Gropus</h6>
                            <select class="form-select form-select-sm total-gropus" aria-label="Default select example">
                        ...
                        <div type="button" class=" my-4 d-flex align-items-center add-row">
                            <h6 class="me-4 text-nowrap">Options per Gropus</h6>
                            <select class="form-select form-select-sm total-gropus" aria-label="Default select example">
                                <option selected>1</option>
                                <option value="2">2</option>
                                <option value="3">3</option>
                    ...
                    <div class="table-responsive my-4">
                        <table class="table">
                            <thead>
                                <tr>
                                    <th scope="col">
                                        <input class="form-control form-control-sm" type="text" placeholder="Gropu Title">
                                    </th>
                                    <th scope="col">
                                        <input class="form-control form-control-sm" type="text" placeholder="Options (Title)">
                                    </th>
                                    <th scope="col">
                                    </th>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="center-td">
                                        <div class="d-flex align-items-center my-1">
                                            <div class="form-check w-100 d-flex justify-content-center align-items-center">
                                                <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault" checked>
                                            </div>
                                            <input class="form-control form-control-sm" type="text" placeholder="1" style="width:12rem">
                                        </div>
                                        <div class="d-flex align-items-center my-1">
                                            <div class="form-check w-100 d-flex justify-content-center align-items-center">
                                                <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault" checked>
