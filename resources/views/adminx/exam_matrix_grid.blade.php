...
<div class="content">
    <div id="exam_matrix_grid">
        <div class="p-md-4 p-3">
            <form id="products">
                <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#">Quiz</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Exam Matrix Grid</li>
                    </ol>
                </nav>
                ...
                <div>
                    <div class="px-4 pt-4 pb-5 bg-white shadow">
                        <table id="exam-matrix-grid" class="table table-responsive">
                            <thead>
                                <tr>
                                    <th scope="col">ID</th>
                                    ...
                                    <td class="text-end">
                                        <div class="btn-reveal-trigger position-static">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                <a class="dropdown-item view-exam-matrix-main-content" type="button">View</a>
            ...
            <div class="row exam-matrix-main-content d-none">
                <div class="d-flex align-items-center mb-4">
                    ...
                    <!-- <h4 class="ms-3 mb-0">Matrix Grid</h4> -->
                    <nav class="ms-3 mt-2" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">Matrix Grid</a></li>
                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">
                                        <input class="form-control form-control-sm" type="text" placeholder="Heading 2">
                                    </th>
                                    <th scope="col">
                                        <input class="form-control form-control-sm" type="text" placeholder="Heading 3">
                                    </th>
                                    <th scope="col">
                                    </th>
                                </tr>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td> <input class="form-control form-control-sm" type="text" placeholder="3">
                                    </td>
                                    <td>
                                        <div class="form-check w-100 d-flex justify-content-center align-items-center">
                                            <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault">
        ...
        <div class="modal-content border">
            <form id="addEventForm" autocomplete="off">
                <div class="modal-header justify-content-between border-0 px-4 py-3">
                    <h4 class="modal-title text-white">Exam Matrix Grid</h4>
                ...
                <div class="modal-footer d-flex justify-content-center align-items-center px-4 pb-4 pt-3">
                    ...
                    <button class="btn btn-done px-4 view-exam-matrix-main-content" type="button" data-bs-dismiss="modal" aria-label="Close">Done</button>
                </div>
            </form>
        </div>
    </div>
