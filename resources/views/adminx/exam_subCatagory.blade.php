        ...
        <form>
            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Exam Sub-Category</li>
                </ol>
            </nav>
            ...
            <!-- <div class="row g-3 justify-content-between mb-2">
                <div class="col-auto">
                    <h3>Exam Sub-Category</h3>
                </div>
                <div class="col-auto">
                    <button class="btn px-3 btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#filterModal" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent">
                        ADD SUB-CATEGORY
                    </button>
                </div>
            </div> -->
            ...
            <div id="products">
                <div class="px-4 pt-4 pb-5 bg-white">
                    <table id="exam-subcategory" class="table table-responsive">
                        <thead>
                            <tr>
                                <!-- <th>
                                ...
                                <th scope="col">ID</th>
                                <th class="text-nowrap" scope="col">EXAM SUB-CATEGORY</th>
                        ...
                        <tbody id="products-table-body">
                            <tr>
                                ...
                                <td class="ps-3">01</td>
                                <td class="ps-3">BIOTECHNOLOGY SKILLS</td>
                            ...
                            <tr>
                                ...
                                <td class="ps-3">02</td>
                                <td class="ps-3">LABORATORY EQUIPMENT</td>
                                <td class="ps-3">Consectetur adipiscing elit.</td>
                                <td class="text-center">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckChecked" checked>
                            ...
                            <tr>
                                ...
                                <td class="ps-3">03</td>
                                <td class="ps-3">APPLIED MATHEMATICS IN BIOTECHNOLOGY</td>
                            ...
                            <tr>
                                ...
                                <td class="ps-3">04</td>
                                <td class="ps-3">RESEARCH & SCIENTIFIC METHOD</td>
                            ...
                            <tr>
                                <td class="ps-3">05</td>
                                <td class="ps-3">GENETIC ENGINEERING</td>
                                <td class="ps-3">Curabitur pretium tincidunt lacus.</td>
                                <td class="text-center">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckChecked" checked>
                                    </div>
                                </td>
                                <td class="ps-3 text-nowrap">Nov 15, 9:00 AM</td>
                                <td class="text-end">
                                    <div class="btn-reveal-trigger position-static">
                                        <button class="btn btn-sm dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <svg class="svg-inline--fa fa-ellipsis" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="ellipsis" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                            ...
                            <tr>
                                <td class="ps-3">06</td>
                                <td class="ps-3">MICROBIOLOGY TECHNIQUES</td>
                                <td class="ps-3">Nam nec ante.</td>
                                <td class="text-center">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckChecked" checked>
                                    </div>
                                </td>
                                <td class="ps-3 text-nowrap">Nov 16, 11:15 AM</td>
                                <td class="text-end">
                                    <div class="btn-reveal-trigger position-static">
                                        <button class="btn btn-sm dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <svg class="svg-inline--fa fa-ellipsis" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="ellipsis" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                            ...
                            <tr>
                                <td class="ps-3">07</td>
                                <td class="ps-3">BIOMEDICAL INSTRUMENTATION</td>
                                <td class="ps-3">Vestibulum ante ipsum primis in faucibus.</td>
                                <td class="text-center">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckChecked">
                                    </div>
                                </td>
                                <td class="ps-3 text-nowrap">Nov 17, 1:45 PM</td>
                                <td class="text-end">
                                    <div class="btn-reveal-trigger position-static">
                                        <button class="btn btn-sm dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <svg class="svg-inline--fa fa-ellipsis" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="ellipsis" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                            ...
                            <tr>
                                <td class="ps-3">08</td>
                                <td class="ps-3">BIOSTATISTICS</td>
                                <td class="ps-3">Aliquam erat volutpat.</td>
                                <td class="text-center">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckChecked" checked>
                                    </div>
                                </td>
                                <td class="ps-3 text-nowrap">Nov 18, 3:00 PM</td>
                                <td class="text-end">
                                    <div class="btn-reveal-trigger position-static">
                                        <button class="btn btn-sm dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <svg class="svg-inline--fa fa-ellipsis" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="ellipsis" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                            ...
                            <tr>
                                <td class="ps-3">09</td>
                                <td class="ps-3">CLINICAL RESEARCH</td>
                                <td class="ps-3">Sed tristique nibh quis libero.</td>
                                <td class="text-center">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckChecked" checked>
                                    </div>
                                </td>
                                <td class="ps-3 text-nowrap">Nov 19, 4:15 PM</td>
                                <td class="text-end">
                                    <div class="btn-reveal-trigger position-static">
                                        <button class="btn btn-sm dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <svg class="svg-inline--fa fa-ellipsis" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="ellipsis" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                            ...
                            <tr>
                                <td class="ps-3">10</td>
                                <td class="ps-3">PHARMACEUTICAL SCIENCES</td>
                                <td class="ps-3">Pellentesque habitant morbi tristique.</td>
                                <td class="text-center">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckChecked">
                                    </div>
                                </td>
                                <td class="ps-3 text-nowrap">Nov 20, 6:30 PM</td>
                                <td class="text-end">
                                    <div class="btn-reveal-trigger position-static">
                                        <button class="btn btn-sm dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <svg class="svg-inline--fa fa-ellipsis" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="ellipsis" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                            ...
                            <tr>
                                <td class="ps-3">11</td>
                                <td class="ps-3">MOLECULAR BIOLOGY</td>
                                ...
                                <td class="ps-3 text-nowrap">Nov 21, 7:45 PM</td>
                                <td class="text-end">
                                    <div class="btn-reveal-trigger position-static">
                                        <button class="btn btn-sm dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <svg class="svg-inline--fa fa-ellipsis" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="ellipsis" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                            ...
                            <tr>
                                <td class="ps-3">12</td>
                                <td class="ps-3">BIOINFORMATICS</td>
                                <td class="ps-3">Donec venenatis vulputate lorem.</td>
                                <td class="text-center">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckChecked" checked>
                                    </div>
                                </td>
                                <td class="ps-3 text-nowrap">Nov 22, 8:00 PM</td>
                                <td class="text-end">
                                    <div class="btn-reveal-trigger position-static">
                                        <button class="btn btn-sm dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <svg class="svg-inline--fa fa-ellipsis" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="ellipsis" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                ...
                <div class="modal-body pt-4 pb-2 px-4">
                    <div class="row">
                        <div class="form-floating col-md-12 mb-3">
                            ...
                            <label class="mx-2" for="generalInfo">Sub-Category General Information</label>
                        </div>
                        <div class="form-floating col-md-12 mb-3">
                            <input type="email" class="form-control" id="examName" placeholder="name@example.com">
                            <label class="mx-2" for="examName">Sub-Category Name</label>
                        </div>
                        <div class="form-floating col-md-12 mb-3">
                            <textarea class="form-control" placeholder="Description" id="floatingTextarea"></textarea>
                            <label class="mx-2" for="floatingTextarea">Sub-Category Description</label>
                        </div>
