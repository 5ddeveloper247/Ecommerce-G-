        ...
        <form>
            ...
            <div id="products">
                <div class="px-4 pt-4 pb-5 bg-white shadow">
                    <table id="exam-category" class="table table-responsive">
                        <thead>
                            <tr>
                                <!-- <th>
                                ...
                                <th scope="col">ID</th>
                                <th class="text-nowrap" scope="col">EXAM CATEGORY</th>
                        ...
                        <tbody id="products-table-body">
                            ...
                            <tr>
                                ...
                                <td class="ps-3">02</td>
                                <td class="ps-3">Multiple choice</td>
                                <td class="ps-3">Consectetur adipiscing elit.</td>
                                <td class="text-center">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckChecked" checked>
                            ...
                            <tr>
                                ...
                                <td class="ps-3">04</td>
                                <td class="ps-3">Open book exams</td>
                            ...
                            <tr>
                                ...
                                <td class="ps-3">06</td>
                                <td class="ps-3">Academic exams</td>
                            ...
                            <tr>
                                ...
                                <td class="ps-3">07</td>
                                <td class="ps-3">Aptitude test</td>
                            ...
                            <tr>
                                ...
                                <td class="ps-3">09</td>
                                <td class="ps-3">Case study exams</td>
                            ...
                            <tr>
                                ...
                                <td class="ps-3">10</td>
                                <td class="ps-3">Internal test</td>
                ...
                <div class="modal-body pt-4 pb-2 px-4">
                    <div class="row">
                        <div class="form-floating col-md-12 mb-3">
                            ...
                            <label class="mx-2" for="generalInfo">Category General Information</label>
                        </div>
                        <div class="form-floating col-md-12 mb-3">
                            <input type="email" class="form-control" id="examName" placeholder="name@example.com">
                            <label class="mx-2" for="examName">Category Name</label>
                        </div>
                        <div class="form-floating col-md-12 mb-3">
                            <textarea class="form-control" placeholder="Description" id="floatingTextarea"></textarea>
                            <label class="mx-2" for="floatingTextarea">Category Description</label>
                        </div>
