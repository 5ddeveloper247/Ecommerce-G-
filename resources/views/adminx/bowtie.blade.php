...
<div class="content">
    <div id="exam_matrix_multiple">
        <div class="p-md-4 p-3">
            <form id="products">
                <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Bowtie</li>
                    </ol>
                </nav>
                ...
                <div>
                    <div class="px-4 pt-4 pb-5 bg-white shadow">
                        <table id="bowtie" class="table table-responsive">
                            <thead>
                                <tr>
                                    <th scope="col">ID</th>
                                    ...
                                    <td class="text-end">
                                        <div class="btn-reveal-trigger position-static">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                <a class="dropdown-item view-bowtie-main-content" type="button">View</a>
            ...
            <div class="row bowtie-main-content d-none">
                <div class="d-flex align-items-center mb-4">
                    ...
                    <nav class="ms-3 mt-2" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">Bowtie</a></li>
                ...
                <div class="col-md-6">
                    ...
                    <div class="d-flex align-items-center mt-4">
                        <h5 class="text-nowrap mb-0 me-2">Bow Ratio</h5>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <input class="form-control form-control-sm" type="text" placeholder="4">
                                    </td>
                                    <td>
                                        <input class="form-control form-control-sm" type="text" placeholder="5">
                                    </td>
                                    <!-- <td>
                                ...
                                <tr>
                                    <td> <input class="form-control form-control-sm" type="text" placeholder="2">
                                    </td>
                                    <td>
                    ...
                    <div class="row justify-content-center align-items-center diagram">
                        <div class="col-3 d-flex flex-column align-items-end">
                            <div class="node my-5">Choose Correct Action</div>
                            <div class="node my-5">Choose Correct Action</div>
                            <!-- <div class="node my-5">Choose Correct Action</div>F -->
                        </div>
                        <div class="col-3 d-flex flex-column align-items-center">
                            <div class="node-main my-5">Choose Correct Condition</div>
                        </div>
                        <div class="col-3 d-flex flex-column align-items-start">
                            <div class="node my-5">Choose Correct Parameter</div>
                            <div class="node my-5">Choose Correct Parameter</div>
                            <!-- <div class="node my-5">Choose Correct Parameter</div> -->
                        </div>
                    </div>
        ...
        <div class="modal-content border">
            <form id="addEventForm" autocomplete="off">
                <div class="modal-header justify-content-between border-0 px-4 py-3">
                    <h4 class="modal-title text-white">Bowtie</h4>
                ...
                <div class="modal-footer d-flex justify-content-center align-items-center px-4 pb-4 pt-3">
                    ...
                    <button class="btn btn-done px-4 view-bowtie-main-content" type="button" data-bs-dismiss="modal" aria-label="Close">Done</button>
                </div>
            </form>
        </div>
    </div>
