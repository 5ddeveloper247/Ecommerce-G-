        ...
        <form>
            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Exam Listing</li>
                </ol>
            </nav>
            ...
            <div id="products">
                <div class="px-4 pt-4 pb-5 bg-white shadow">
                    <table id="exam-listing" class="table table-responsive">
                        <thead>
                            <tr>
                                <!-- <th>
                        ...
                        <tbody id="products-table-body">
                            ...
                            <tr>
                                ...
                                <td class="ps-3">10</td>
                                <td class="ps-3">Computer Science</td>
        ...
        <div class="modal-content border">
            <form id="addEventForm" autocomplete="off">
                <div class="modal-header justify-content-between border-0 px-4 py-3">
                    <h4 class="modal-title text-white">Exam</h4>
                ...
                <div class="modal-body pt-4 pb-2 px-4">
                    <div class="row">
                        <div class="form-floating col-md-12 mb-3">
                            ...
                            <label class="mx-2" for="generalInfo">Exam General Information</label>
                        </div>
                        <div class="form-floating col-md-12 mb-3">
                            <input type="email" class="form-control" id="examName" placeholder="name@example.com">
                            <label class="mx-2" for="examName">Exam Name</label>
                        </div>
                        <div class="form-floating col-md-12 mb-3">
                            <textarea class="form-control" placeholder="Description" id="floatingTextarea"></textarea>
                            <label class="mx-2" for="floatingTextarea">Description</label>
                        </div>
