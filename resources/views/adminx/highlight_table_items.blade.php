...
<div class="content">
    <div id="highlight-table-items">
        <div class="p-md-4 p-3">
            <form id="products">
                <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#">Quiz</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Highlight Table Items</li>
                    </ol>
                </nav>
            ...
            <div class="row rational-main-content d-none">
                <div class="d-flex align-items-center mb-4">
                    ...
                    <nav class="ms-3 mt-2" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">Highlight Table Items</a></li>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <span type="button" data-bs-toggle="modal" data-bs-target="#modal2" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 256 256">
                                            Click to open PopUp
                                        </span>
                                    </td>
...
<div class="modal fade drop-down-table" id="modal2" tabindex="-1" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border border-translucent">
            <form id="addEventForm" autocomplete="off">
                <div class="modal-header justify-content-between border-translucent p-4">
                    <h5 class="modal-title fs-6 lh-sm">Add Statement
                    </h5>
                ...
                <div class="modal-body px-4 pb-0">
                    <textarea id="editor8"></textarea>
                    <div class="form-check mt-4">
                        <input class="form-check-input me-3" type="checkbox" name="flexRadioDefault" id="flexRadioDefault1" checked>
