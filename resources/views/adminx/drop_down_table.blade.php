...
<div class="content">
    <div id="drop-down-table">
        <div class="p-md-4 p-3">
            <form id="products">
                <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#">Quiz</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Drop Down Table</li>
                    </ol>
                </nav>
                ...
                <div>
                    <div class="px-4 pt-4 pb-5 bg-white shadow">
                        <table id="rational" class="table table-responsive">
                            <thead>
                                <tr>
                                    <th scope="col">ID</th>
                                    ...
                                    <td class="text-end">
                                        <div class="btn-reveal-trigger position-static">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                <a class="dropdown-item view-rational-main-content" type="button">View</a>
            ...
            <div class="row rational-main-content d-none">
                <div class="d-flex align-items-center mb-4">
                    ...
                    <nav class="ms-3 mt-2" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">Drop Down Table</a></li>
                ...
                <div class="col-md-6">
                    ...
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane pre-info-tab-content fade show active" id="nav-Title1" role="tabpanel" aria-labelledby="nav-Title1-tab" tabindex="0">A 28-year-old client is brought to the ED by friends,
                        ...
                        <div class="tab-pane pre-info-tab-content fade" id="nav-Title2" role="tabpanel" aria-labelledby="nav-Title2-tab" tabindex="0">
                        ...
                        <div class="tab-pane pre-info-tab-content fade" id="nav-Title3" role="tabpanel" aria-labelledby="nav-Title3-tab" tabindex="0">Lorem ipsum, dolor sit amet consectetur adipisicing elit. At debitis porro omnis.</div>
                        <div class="tab-pane pre-info-tab-content fade" id="nav-Title4" role="tabpanel" aria-labelledby="nav-Title4-tab" tabindex="0">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Sapiente error illum dolorem quo dignissimos voluptate voluptatibus praesentium libero?</div>
                    </div>
                    <h5 class="my-4">
                        Post Statement
                    </h5>
                ...
                <div class="col-md-6">
                    ...
                    <div class="d-flex justify-content-between">
                        <button type="button" class="btn btn-outline-primary my-4 d-flex align-items-center add-row">
                            Add Row
                            <span class="ps-2">
                    ...
                    <div class="table-responsive mb-4">
                        <table class="table">
                            <thead>
                                <tr>
                                    <th scope="col">
                                        <input class="form-control form-control-sm" type="text" placeholder="Heading 1">
                                    </th>
                                    <th scope="col">
                                        <div class="d-flex align-items-center">
                                            <input class="form-control form-control-sm me-2" type="text" placeholder="Heading 2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <svg class="plus-svg-table ms-2" data-bs-toggle="modal" data-bs-target="#modal2" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 256 256">
                                                <path fill="green" d="M228 128a12 12 0 0 1-12 12h-76v76a12 12 0 0 1-24 0v-76H40a12 12 0 0 1 0-24h76V40a12 12 0 0 1 24 0v76h76a12 12 0 0 1 12 12" />
                                            </svg>
                                        </div>
                                    </td>
                                    <td>
                ...
                <div class="d-flex justify-content-center">
                    ...
                    <button type="button" class="btn btn-outline-primary my-4 d-flex align-items-center px-md-5 mx-1">
                        Save
                    </button>
                </div>
            </div>
...
<!-- Modal 2  -->
<div class="modal fade drop-down-table" id="modal2" tabindex="-1" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-sm modal-dialog-centered">
        <div class="modal-content border border-translucent">
            <form id="addEventForm" autocomplete="off">
                <div class="modal-header justify-content-between border-translucent p-4">
                    <h5 class="modal-title fs-6 lh-sm">Add Options
                    </h5>
                    <button class="btn p-1 text-danger" type="button" data-bs-dismiss="modal" aria-label="Close">
                        <svg class="svg-inline--fa fa-xmark" width="0.9em" height="0.9em" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="xmark" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" data-fa-i2svg="">
                            <path fill="currentColor" d="M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z">
                            </path>
                        </svg>
                    </button>
                ...
                <div class="modal-body px-4 pb-0">
                    <div class="d-flex justify-content-between align-items-center">
                        <input class="form-control form-control-sm me-2" type="text" placeholder="Add Option Input Field">
                        <svg class="plus-svg-table" data-bs-toggle="modal" data-bs-target="#modal2" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 256 256">
                            <path fill="green" d="M228 128a12 12 0 0 1-12 12h-76v76a12 12 0 0 1-24 0v-76H40a12 12 0 0 1 0-24h76V40a12 12 0 0 1 24 0v76h76a12 12 0 0 1 12 12" />
                        </svg>
                    </div>
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="0.9em" height="0.9em" viewBox="0 0 15 15">
        ...
        <div class="modal-content border">
            <form id="addEventForm" autocomplete="off">
                ...
                <div class="modal-footer d-flex justify-content-center align-items-center px-4 pb-4 pt-3">
                    ...
                    <button class="btn btn-done px-4 view-rational-main-content" type="button" data-bs-dismiss="modal" aria-label="Close">Done</button>
                </div>
            </form>
        </div>
    </div>
